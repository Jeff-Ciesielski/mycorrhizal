#!/usr/bin/env python3
"""
Standalone Spores Demo - SYNC VERSION

This demo shows how to use Spores for OCEL-compatible logging
in synchronous Python applications using the explicit API.
"""
...
# Configure spores with sync transport
configure(
    enabled=True,
    transport=SyncFileTransport("logs/sync_ocel.jsonl"),
    object_cache_size=100
)

# Get sync spore instance (explicit)
...
class OrderProcessingSystem:
    ...
    def ship_order(self, order: Order, address: str) -> None:
        """Ship an order."""
...
def main():
    ...
    print("=" * 70)
    print("Standalone Spores Demo - SYNC VERSION")
    print("=" * 70)
    print()
    ...
    print("=" * 70)
    print("Demo complete! Check 'logs/sync_ocel.jsonl' for OCEL output")
    print("=" * 70)
    print()
